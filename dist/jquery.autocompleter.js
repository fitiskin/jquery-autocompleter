...
(function (global, factory) {
  ...
  (function ($, window) {
    ...
    var guid = 0,
      ...
      allowOptions = ['source', 'empty', 'limit', 'cache', 'cacheExpires', 'focusOpen', 'selectFirst', 'changeWhenSelect', 'highlightMatches', 'ignoredKeyCode', 'customLabel', 'customValue', 'template', 'offset', 'combine', 'callback', 'minLength', 'delay', 'beforeNewLaunch', 'allowPreventEnter'],
    ...
    function _update(data) {
      ...
      _handleChange(data);
      _clear(data);
      _setCache('autocompleter-selectedtext', data.$node.val());
    }
     ...
     * @param key [string] "AJAX get query string"
     * @param value [object] "AJAX response data"
     */
     ...
     * @param key [string] "AJAX get query string"
     */
    function _getCache(key, expires) {
      var response = false,
        item;
